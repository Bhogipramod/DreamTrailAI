            ...
            <div key={idx} className="relative group">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 bg-slate-900/50 border border-slate-800/80 rounded-xl p-4">
                  <div>
                    <span className="text-[10px] uppercase text-slate-500 font-bold tracking-wider block">Why this fits your goals</span>
                  ...
                  <div className="border-t md:border-t-0 md:border-l border-slate-800 pt-3 md:pt-0 md:pl-4">
                    <span className="text-[10px] uppercase text-amber-400/80 font-bold tracking-wider block">📷 Core Memory Spot</span>
                    <p className="text-xs text-slate-400 mt-1 italic">"{item.photo_moment}"</p>
                  </div>
                </div>
              </div>
            </div>
